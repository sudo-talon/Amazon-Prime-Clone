...
1. **Clone the Repository** (Open Command Prompt & run below):
   ```bash
<<<<<<< HEAD
   git clone https://github.com/sudo-talon/amazonprimeclone.git)
   cd amazonprimeclone
=======
...
pipeline {
    ...
    stages {
        stage('1. Git Checkout') {
            steps {
<<<<<<< HEAD
                git branch: 'main', url: 'https://github.com/sudo-talon/amazonprimeclone.git'
=======
...
<<<<<<< HEAD
Project was inspired by #Pandacloud
=======
>>>>>>> 590265c (update_amazon_prime_clone)
